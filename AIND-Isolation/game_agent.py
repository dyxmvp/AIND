...
def custom_score_2(game, player):
    ...
    # TODO: finish this function!
    """
    This evaluation function first measures how many choices the player has
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        for move in moves:
        	...
        	score = self.min_player(new_game, depth - 1)
        	if score > best_score:
        		best_move = move
        		best_score = score
    ...
    def min_player(self, game, depth):
        """Implement as opponent player to minimize the player's score.
        ...
        if depth == 0:
        	return self.score(game, self) #len(moves)
        best_score = float('inf')
        for move in moves:
        	new_game = game.forecast_move(move)
        	score = self.max_player(new_game, depth - 1)
        	if score < best_score:
        		best_move = move
        		best_score = score
        return best_score
    ...
    def max_player(self, game, depth):
        """Implement as player to maximize the player's score.
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        for move in moves:
        	new_game = game.forecast_move(move)
        	score = self.min_player(new_game, depth - 1, alpha, beta)
        	if score > best_score:
        		best_move = move
        		best_score = score
    ...
    def min_player(self, game, depth, alpha, beta):
        """Implement as opponent player to minimize the player's score.
        ...
        for move in moves:
        	new_game = game.forecast_move(move)
        	score = self.max_player(new_game, depth - 1, alpha, beta)
        	if score < best_score:
        		best_move = move
        		best_score = score
        	if best_score <= alpha:
    ...
    def max_player(self, game, depth, alpha, beta):
        """Implement as player to maximize the player's score.
