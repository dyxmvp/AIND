...
function drawFeaturePoints(canvas, img, face) {
  ...
  for (var id in face.featurePoints) {
    ...
    // See: https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/arc24                                      b
    // <your code here>
    ctx.beginPath();
...
function drawEmoji(canvas, img, face) {
  ...
  // <your code here>
  ctx.fillText(face.emojis.dominantEmoji, face.featurePoints[10].x + 1, face.featurePoints[10].y);
}
