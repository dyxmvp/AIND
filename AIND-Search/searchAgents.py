...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        #self.corners_unvisited = [c for c in self.corners]
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        #print 'start state is: ', self.startingPosition
...
def cornersHeuristic(state, problem):
    ...
    while (len(corners_visited) < 4):
        distance, corner = min([(util.manhattanDistance(xy1, corner), corner) for corner in corners
                                if not corner in corners_visited])
        sum += distance
        xy1 = corner
        corners_visited.append(corner)
